...
\begin{itemize}
  \item Used machine learning functions from Scikit-learn to enter Kaggle competitions
...
\linehead{BC Cancer Agency, UBC}{Jan.2014 -- Aug.2014}
...
\linehead{BC Cancer Agency, PHSA}{Sept.2013 -- Dec.2013}
